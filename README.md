...
<br />제가 느낀 즐거움을 다른 사람들에게 나누어서 행복하게 해주는 게임 개발자가 되고 싶습니다.
...
- 목표를 달성하기 위해 전체 구조와 리스크를 분석하여 문제를 인지하고 대처하고자 합니다.
- 이해하기 쉽고 꼼꼼하게 작성된 코드를 짜려고 노력합니다.


### 🎯 목표

- 팀의 윤활유 역할을 수행하며 팀원의 어려움을 좌시하지 않고 저의 일처럼 도와서 긍정적인 시너지를 만들고 싶습니다.
- 주어진 일에 책임감 있게 해내는 게임 개발자가 되고 싶습니다.
...
유니티 입문을 목적으로 골드메탈의 2d 뱀서류 게임 에셋과 2d 픽셀 캐릭터 에셋(SPUM)을 활용하여 제작한 간단한 탄막 피하기 게임입니다.
...
- 게임 프로그래밍 기초 및 Unity 기반 실습
    ...
    - Prefab, Scenes, new Input System, CG에 대해 배움
<br />
...
- 게임 핵심 로직 및 UI 구현:
    - **Raycast**를 이용하여 자원 탐지, 생성, 채굴 및 도구 스왑 시스템을 구현함
    - 도구 교체에 쓰는 UI 아이콘 및 도구 오브젝트를 직접 제작함
    - **Directional Light**을 이용하여 밤과 낮 구현을 할 예정
- 전체적인 로직 설계 및 통합:
    - 요구사항 분석을 통해 NPC, 인벤토리 시스템 등의 전체적인 시스템 구조를 설계함
    - 팀원들이 작성한 로직 스크립트의 통합을 담당함
...
| 개발/보안 중앙동아리 Aegis 운영진 | 2024년 12월 - 현재 | **- 테크톡 2회 참여** : Unity의 최적화 기법인 **[오브젝트 풀링](오브젝트_풀링이란.pdf)** 과 **[코루틴](코루틴이란_in_Unity_박세웅.pdf)** 에 대해서 발표<br />**- [Mini Project 경연대회](https://dkuaegis.notion.site/2025-mini-project) 기획 및 진행** : 프로젝트에 익숙치않은 저학년 개발자들을 위해 선배들의 멘토링을 지원하여, 스스로 사이드 프로젝트를 진행하는 프로그램을 기획 및 진행중 (2025년 2학기 동아리 인원의 10%인 7명이 참여함) <br />**- 해커톤([Easython](https://easy-thon.github.io/)) 기획 및 개최 :** 대외활동 경험이 부족한 단국대 개발자들을 위한 해커톤으로 SW중심대학사업단의 후원을 받아 진행중<br />- 매 학기 C언어를 가르치는 **스터디**를 열어 1학년과 복학생 후배들에게 도움을 줌 |
| Aegis 코드클럽 담당 | 2025년 3월 - 현재 | Aegis 소속 대학생들이 대지중학교 학생들에게 총 7주간 파이썬을 알려주는 **코딩 봉사활동**을 담당 교사분과 협의하여 매 학기 운영, 봉사자의 공백이 생기면 예비 교사로 활동 |
| 컴투스 멘토링 스쿨 | 2025년 11월 20일 - 11월 21일(예정) | **게임 클라이언트 개발**과 **게임 기획**에 대한 세션에 참여하여 직무에 대한 이해도를 높이고 현업자분들과 멘토링을 진행할 예정 |
